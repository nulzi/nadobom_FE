...
public class PrePostProcessor {
    ...
    private static int mOutputColumn = 19; // class num + 5(left, right, top, bottom, score)
    private static float mThreshold = 0.55f; // score above which a detection is generated
