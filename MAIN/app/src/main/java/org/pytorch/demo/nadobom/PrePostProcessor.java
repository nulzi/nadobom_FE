...
public class PrePostProcessor {
    ...
    private static int mOutputColumn = 17; // class num + 5(left, right, top, bottom, score)
    private static float mThreshold = 0.77f; // score above which a detection is generated
    private static int mNmsLimit = 10;
